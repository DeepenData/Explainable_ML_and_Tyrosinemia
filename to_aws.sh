...
ray rsync-up aws-ray-cluster.yml tirosinemia.csv tirosinemia.csv 
ray rsync-up aws-ray-cluster.yml tirosinemia_italia.csv tirosinemia_italia.csv
...
ray rsync-down aws-ray-cluster.yml /home/ubuntu/1a_hello_aws.pickle aws-downloads/1a_hello_aws.pickle
